...
:::definition "from_" (parent := "models") (lean := "LaxLogic.Obligation.Timing.from_")
...
:::theorem "meet_lower" (parent := "models") (lean := "LaxLogic.Obligation.Timing.meet_lowerBound")
...
:::theorem "image_delay" (parent := "models") (lean := "LaxLogic.Obligation.Timing.image_delay")
Propagating a constraint through a component of delay `d` shifts the bound by
`d` — sequential composition.
:::

:::theorem "pipeline" (parent := "models") (lean := "LaxLogic.Obligation.Timing.pipeline")
...
:::definition "atLeast" (parent := "models") (lean := "LaxLogic.Obligation.Budget.atLeast")
A budget covering a cost.  Formally identical to `from_`.
:::

:::theorem "budget_combine" (parent := "models") (lean := "LaxLogic.Obligation.Budget.combine")
...
:::theorem "budget_share" (parent := "models") (lean := "LaxLogic.Obligation.Budget.share")
...
:::theorem "treeGates_eq" (parent := "models") (lean := "LaxLogic.Obligation.Budget.treeGates_eq")
`treeGates k = 2ᵏ - 1`.
:::

:::theorem "tree32_fits" (parent := "models") (lean := "LaxLogic.Obligation.Budget.tree32_fits")
The 32-bit block's thirty-one cells fit a forty-cell budget — discharged from a
synthesised obligation, not an assumed one.
:::

:::theorem "tree32_too_big" (parent := "models") (lean := "LaxLogic.Obligation.Budget.tree32_too_big")
...
:::theorem "meet_unit" (parent := "models") (lean := "LaxLogic.Obligation.Timing.meet_unit")
...
:::theorem "weak_singleton" (parent := "models") (lean := "LaxLogic.Obligation.weak_singleton")
A one-element constraint is `Debt`.
:::

:::theorem "laxAll_as_weak" (parent := "models") (lean := "LaxLogic.Obligation.laxAll_as_weak")
...
:::theorem "weak_debt" (parent := "models") (lean := "LaxLogic.Obligation.StdCtxBridge.weak_iff_debt_allOf")
Mendler's constraint is `Debt` at the **conjunction** of its demands.
:::

:::theorem "applyP_bot" (parent := "models") (lean := "LaxLogic.Obligation.StdCtxBridge.applyP_bot_iff")
...
:::theorem "sound" (parent := "models") (lean := "LaxLogic.Obligation.PLLBridge.sound")
