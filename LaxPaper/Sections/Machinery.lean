...
:::definition "laxall" (parent := "mach_modal") (lean := "LaxAll")
...
:::theorem "laxall_meet" (parent := "mach_modal") (uses := "laxall") (lean := "laxAll_meet")
The rule `◯∧`: constraints on a shared witness combine by conjunction.
:::

:::theorem "laxall_image" (parent := "mach_modal") (uses := "laxall") (lean := "laxAll_image")
The rule `◯⊃`: a constraint propagates through a component along the direct
image of the component's refinement part.
:::

:::theorem "laxall_mono" (parent := "mach_modal") (uses := "laxall") (lean := "laxAll_mono")
...
:::definition "debt" (parent := "mach_modal") (uses := "laxall") (lean := "Debt")
...
:::theorem "debt_nucleus" (parent := "mach_modal") (uses := "debt") (lean := "debt_eq_openNucleus")
...
:::definition "postpone" (parent := "mach_tactic") (uses := "debt") (lean := "postponeCore")
...
:::definition "weak" (parent := "mach_tactic") (uses := "debt") (lean := "weak")
...
:::theorem "weak_append" (parent := "mach_tactic") (uses := "weak") (lean := "weak_append")
