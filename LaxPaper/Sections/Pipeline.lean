...
:::theorem "buffer" (parent := "pipe") (lean := "LaxLogic.Obligation.Modular.buffer")
The one-input refinement rule: availability shifts by the delay.
:::

:::theorem "datapath" (parent := "pipe") (lean := "LaxLogic.Obligation.Modular.datapath_meets_clock")
Stage 2, the carry-lookahead block plus its sum XOR.  Two obligations: the
block's, borrowed, and the XOR's, new.
:::

:::theorem "pipeline_thm" (parent := "pipe") (lean := "LaxLogic.Obligation.Modular.pipeline_meets_clock")
...
:::theorem "is_weak" (parent := "pipe") (lean := "LaxLogic.Obligation.Modular.pipeline_is_weak")
The statement as `weak [C₁,C₂,C₃] φ`, with the theorem itself as the proof.
:::

:::theorem "ledger_append" (parent := "pipe") (lean := "LaxLogic.Obligation.Modular.pipeline_ledger_append")
...
:::theorem "expanded" (parent := "pipe") (lean := "LaxLogic.Obligation.Modular.pipeline_debt_expanded")
...
:::theorem "concrete" (parent := "pipe") (lean := "LaxLogic.Obligation.Modular.pipeline_concrete")
The concrete theorem, obtained from the abstract one by evaluation.  No timing
hypothesis survives.
:::

:::theorem "too_tight" (parent := "pipe") (lean := "LaxLogic.Obligation.Modular.pipeline_too_tight")
...
:::theorem "earliest" (parent := "pipe") (lean := "LaxLogic.Obligation.Modular.pipeline_earliest")
