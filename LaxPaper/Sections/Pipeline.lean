...
:::definition "UnitSpec" (parent := "pipe") (lean := "Modular.UnitSpec")
...
:::theorem "buffer" (parent := "pipe") (uses := "UnitSpec, from_") (lean := "Modular.buffer")
The one-input refinement rule: availability shifts by the delay.
:::

:::theorem "datapath" (parent := "pipe") (uses := "bal_meets_cycle, carry_cell, postpone") (lean := "Modular.datapath_meets_clock")
Stage 2, the carry-lookahead block plus its sum XOR.  Two obligations: the
block's, borrowed, and the XOR's, new.
:::

:::theorem "pipeline_thm" (parent := "pipe") (uses := "datapath, buffer, postpone") (lean := "Modular.pipeline_meets_clock")
...
:::theorem "is_weak" (parent := "pipe") (uses := "pipeline_thm, weak") (lean := "Modular.pipeline_is_weak")
The statement as `weak [C₁,C₂,C₃] φ`, with the theorem itself as the proof.
:::

:::theorem "ledger_append" (parent := "pipe") (uses := "weak_append") (lean := "Modular.pipeline_ledger_append")
...
:::theorem "expanded" (parent := "pipe") (uses := "debt") (lean := "Modular.pipeline_debt_expanded")
...
:::theorem "concrete" (parent := "pipe") (uses := "pipeline_thm, solvefor") (lean := "Modular.pipeline_concrete")
The concrete theorem, obtained from the abstract one by evaluation.  No timing
hypothesis survives.
:::

:::theorem "too_tight" (parent := "pipe") (uses := "pipeline_thm") (lean := "Modular.pipeline_too_tight")
...
:::theorem "earliest" (parent := "pipe") (uses := "pipeline_thm") (lean := "Modular.pipeline_earliest")
