...
|---|-----------|----------|------------|
| 1 | `SC [◯G′, F′] r` (G3-derivability) | `theorem sep_SC` in `LaxLogic/PLL/G4/G4Gap.lean` | **Lean kernel** (an explicit derivation term; axioms: `propext, Quot.sound` — choice-free since the 2026-07-17 hygiene pass) |
...
(`LaxLogic/PLL/Search/Decide.lean`):
