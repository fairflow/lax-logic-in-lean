/- Generated by prover-toolkit/challenge.py -- DO NOT EDIT.

   `LaxLogic/Focusing/LJFComplete.lean` with 8 declaration(s) removed: `allI_min`, `allI_sound`, `exI_min`, `exI_sound`, `focalization`, `map_unNeg_negOf`, `pfreeCtx`, `uniform_interpolation_IPC`.
