# Retired challenge set — kept as a record, not a benchmark

These four files were the first challenge set, generated by bare prefix
truncation. All four were proved on 2026-08-30 (see below), and the set was
then **retired**: it is contaminated by construction and cannot measure what
