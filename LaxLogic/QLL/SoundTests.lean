...
theorem val_sound : Sat 𝔅 [] ρ₀ qf[◯∀ ⊤] (denoteC 𝔅 d_val ρ₀) :=
...
theorem gen_sound : Sat 𝔅 [] ρ₀ qf[∀a. ⊤] (denoteC 𝔅 d_gen ρ₀) :=
...
theorem η_ok_sat : PSat 𝔅 ρ₀ qc[u : P] η_ok := .cons rfl .nil

theorem ex_sound : Sat 𝔅 [] ρ₀ qf[◯∃ P] (denote 𝔅 d_ex η_ok ρ₀) :=
...
theorem η_bad_not_sat : ¬ PSat 𝔅 ρ₀ qc[u : P] (.cons false .nil) := by
  intro h
  cases h with
...
/-- info: 'LaxLogic.QLL.Sat_openAt' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in #print axioms Sat_openAt
