...
modality \ensuremath{\bigcirc} has aspects both of possibility and of necessity: we read
...
classical belief modality collapses to \ensuremath{\bigcirc M \equiv M \vee a} for a fixed
...
\ensuremath{\bigcirc} differ in how much a realiser is given about the future of the
...
cannot support a completeness theorem, by an obstruction inherent in
strategy evidence; presenting the future at implications yields
