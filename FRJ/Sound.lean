...
theorem joinAt_case {G : Form} {n : Nat} {stab th : Fin (n + 1) → List Form}
    ...
    let d := FRJr.joinAt prem hJ1 hJ2 hcirc hF hFnot hg rfl
    (∀ w, (modR d).forces w
        ((preR d).lbl w)) ∧
      ¬ (modR d).force
          (modR d).root F := by
...
theorem joinOr_case {G : Form} {n : Nat} {stab th : Fin (n + 1) → List Form}
    ...
    (ihI : ∀ (j : Fin (n + 1)) (P : PreModel) (hP : ClosedLbl P) (w : P.W),
        ...
        (P.toKripke hP).forces w (cap (stab j) (sfm (rhs j))) →
        ¬ (P.toKripke hP).force w (rhs j)) :
    let d := FRJr.joinOr prem hJ1 hJ2 hcirc hC hg rfl
    (∀ w, (modR d).forces w
        ((preR d).lbl w)) ∧
      ¬ (modR d).force
...
theorem joinAtP_case {G : Form} {n k : Nat} {stab th : Fin (n + 1) → List Form}
    ...
    let d := FRJr.joinAtP prem dps hJ1 hJ2 hJ5 hJ7 htag hF hFnot hg rfl
    (∀ w, (modR d).forces w
        ((preR d).lbl w)) ∧
      ¬ (modR d).force
          (modR d).root F := by
...
theorem joinAtF_case {G : Form} {n : Nat} {stab th : Fin (n + 1) → List Form}
    ...
    (ihI : ∀ (j : Fin (n + 1)) (P : PreModel) (hP : ClosedLbl P) (w : P.W),
        ...
        (P.toKripke hP).forces w (cap (stab j) (sfm (rhs j))) →
        ¬ (P.toKripke hP).force w (rhs j)) :
    let d := FRJr.joinAtF prem hJ1 hJ2 hF hFnot hg rfl
    (∀ w, (modR d).forces w
        ((preR d).lbl w)) ∧
      ¬ (modR d).force
          (modR d).root F := by
...
theorem joinOrP_case {G : Form} {n k : Nat} {stab th : Fin (n + 1) → List Form}
    ...
    (ihP : ∀ i, (∀ w, (modR (dps i)).forces w ((preR (dps i)).lbl w)) ∧
        ¬ (modR (dps i)).force (modR (dps i)).root (Ds i)) :
    let d := FRJr.joinOrP prem dps hJ1 hJ2 hJ5 hJ7 htag hC hg rfl
    (∀ w, (modR d).forces w
        ((preR d).lbl w)) ∧
      ¬ (modR d).force
          (modR d).root (.or C₁ C₂) := by
...
theorem joinOrF_case {G : Form} {n : Nat} {stab th : Fin (n + 1) → List Form}
    ...
    (ihI : ∀ (j : Fin (n + 1)) (P : PreModel) (hP : ClosedLbl P) (w : P.W),
        ...
        (P.toKripke hP).forces w (cap (stab j) (sfm (rhs j))) →
        ¬ (P.toKripke hP).force w (rhs j)) :
    let d := FRJr.joinOrF prem hJ1 hJ2 hC hg rfl
    (∀ w, (modR d).forces w
        ((preR d).lbl w)) ∧
      ¬ (modR d).force
          (modR d).root (.or C₁ C₂) := by
...
theorem joinCirc_case {G : Form} {n : Nat} {stab th : Fin (n + 1) → List Form}
    ...
    (ihI : ∀ (j : Fin (n + 1)) (P : PreModel) (hP : ClosedLbl P) (w : P.W),
        ...
        (P.toKripke hP).forces w (cap (stab j) (sfm (rhs j))) →
        ¬ (P.toKripke hP).force w (rhs j)) :
    let d := FRJr.joinCirc prem hJ1 hJ2 hcirc hZ hg rfl
    (∀ w, (modR d).forces w
        ((preR d).lbl w)) ∧
      ¬ (modR d).force
...
theorem joinCircP_case {G : Form} {n k : Nat} {stab th : Fin (n + 1) → List Form}
    ...
    let d := FRJr.joinCircP prem dps hJ1 hJ2 hJ5 hJ7 hDs hZ hg rfl
    (∀ w, (modR d).forces w
        ((preR d).lbl w)) ∧
      ¬ (modR d).force
          (modR d).root (.circ Z) := by
