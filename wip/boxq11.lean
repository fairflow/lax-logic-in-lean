...
theorem ref_boxq11_q11 : [bq11] ⊬ q11 :=
...
/-- `◯q11 ⊬ q13`. -/
theorem ref_boxq11_q13 : [bq11] ⊬ q13 :=
  FinCM.not_provable_of_check
...
/-- `q13 ⊬ ◯q11`. -/
theorem ref_q13_boxq11 : [q13] ⊬ bq11 :=
  FinCM.not_provable_of_check
...
/-- `◯q11 ⊬ q12`. -/
theorem ref_boxq11_q12 : [bq11] ⊬ q12 :=
  FinCM.not_provable_of_check
    (M := ⟨5, [(0, 1), (0, 2), (0, 3), (0, 4), (1, 2)], [(1, 2)], [2], []⟩)
    (w := 0) (by decide)

/-- `◯q11 ⊬ q9`. -/
theorem ref_boxq11_q9 : [bq11] ⊬ q9 :=
  FinCM.not_provable_of_check
    (M := ⟨5, [(0, 1), (0, 2), (0, 3), (0, 4), (1, 2)], [(1, 2)], [2], []⟩)
    (w := 0) (by decide)

/-- `◯q11 ⊬ q14`. -/
theorem ref_boxq11_q14 : [bq11] ⊬ q14 :=
  FinCM.not_provable_of_check
    (M := ⟨5, [(0, 1), (0, 2), (0, 3), (0, 4), (1, 2)], [(1, 2)], [2], []⟩)
    (w := 0) (by decide)

/-- `q14 ⊬ ◯q11`. -/
theorem ref_q14_boxq11 : [q14] ⊬ bq11 :=
  FinCM.not_provable_of_check
    (M := ⟨5, [(0, 1), (0, 2), (0, 3), (0, 4), (1, 2), (1, 3), (2, 3)],
           [(2, 3)], [3], []⟩)
    (w := 0) (by decide)
